    ...
    runService:BindToRenderStep("esp_rendering", renderValue or (Enum.RenderPriority.Camera.Value + 1), function()
        for player, objects in next, self.espCache do
            ...
            if (character and torso) then
                ...
                objects.top.Text = player.DisplayName;
                ...
                objects.line.From =
                    ...
                    origin == "Bottom" and vector2New(viewportSize.X * 0.5, viewportSize.Y) or
                    origin == "Center" and workspace.CurrentCamera.ViewportSize/2;
        ...
        for player, highlight in next, self.chamsCache do
            ...
            if (character and torso) then
                ...
                if (find(self.whitelist, player.DisplayName)) then
                    color = self.options.whitelistColor;
                end

                if (find(self.blacklist, player.DisplayName)) then
                    canShow = false;
                end
