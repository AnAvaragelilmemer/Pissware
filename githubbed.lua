...
home:AddParagraph("Welcome!", "welcome to pissware, i will ensure you a great exploiting experince and fun")
home:AddParagraph("Tip", "always take a break!")
